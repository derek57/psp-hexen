...
//extern boolean devparm_opl_music;
...
static boolean LoadInstrumentTable(void)
{
    ...
    if(HEXEN_BETA_DEMO || HEXEN_BETA || HEXEN_DEMO || HEXEN_1_0 || HEXEN_1_1)
	lump = W_CacheLumpName("GENMIDI", PU_STATIC);
    else
	lump = W_CacheLumpName("MACMIDI", PU_STATIC);
