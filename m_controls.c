...
int key_invright = KEY_TRIANGLE;
int key_jump = KEY_CROSS;
int key_mission   = KEY_SQUARE;
int key_invpop    = KEY_CIRCLE;
int key_strafeleft = KEY_SELECT;		// FOR PSP: THIS IS RESERVED AS A SPECIAL KEY
int key_invuse    = KEY_START;
int key_use = KEY_LEFTTRIGGER;
int key_fire = KEY_RIGHTTRIGGER;
*/
...
int key_map_zoomin    = KEY_SQUARE;
int key_map_zoomout   = KEY_CIRCLE;
*/
...
int key_menu_activate  = KEY_SELECT;
int key_menu_up        = KEY_UPARROW;
int key_menu_down      = KEY_DOWNARROW;
int key_menu_left      = KEY_LEFTARROW;
int key_menu_right     = KEY_RIGHTARROW;
int key_menu_back      = KEY_TRIANGLE;
int key_menu_forward   = KEY_CROSS;
int key_menu_confirm   = KEY_START;
int key_menu_abort     = KEY_CIRCLE;
/*
...
*/
    ...
    M_BindVariable("movement_speed",         &mouseSensitivity);
