...
static void TextWrite(void)
{
    ...
    memcpy(screens[0]/*I_VideoBuffer*/, W_CacheLumpNum(FinaleLumpNum, PU_CACHE),
...
/*
        if (netgame)
        {
            V_DrawPatch(20, 0, 0, W_CacheLumpName("chessall", PU_CACHE));
        }
        else*/ if (PlayerClass[consoleplayer])
        {
            V_DrawPatch(60, 0, 0, W_CacheLumpNum(W_GetNumForName("chessc")
