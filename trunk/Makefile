...
OBJS =											\
a_action.o am_map.o d_net.o f_finale.o g_game.o h2_main.o h_hubmsg.o i_endoom.o		\
in_lude.o info.o mn_menu.o m_random.o p_acs.o p_anim.o p_ceilng.o p_doors.o p_enemy.o	\
p_floor.o p_inter.o p_lights.o p_map.o p_maputl.o p_mobj.o po_man.o p_plats.o p_pspr.o	\
p_setup.o p_sight.o p_spec.o p_switch.o p_telept.o p_things.o p_tick.o p_user.o r_bsp.o	\
r_data.o r_draw.o r_main.o r_plane.o r_segs.o r_things.o sb_bar.o sc_man.o sn_sonix.o	\
sounds.o s_sound.o st_start.o sv_save.o							\
											\
...
PSP_EBOOT_TITLE = PSP-Hexen by nitr8 (R5)
