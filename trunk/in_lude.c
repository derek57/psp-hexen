...
void IN_Drawer(void)
{
    ...
    memcpy(screens[0]/*I_VideoBuffer*/, (byte *) patchINTERPIC, SCREENWIDTH * SCREENHEIGHT);
...
static void DrDeathTally(void)
{
    ...
    V_DrawPatch(TALLY_TOP_X, TALLY_TOP_Y, 0, 
                W_CacheLumpName("tallytop", PU_CACHE));
    V_DrawPatch(TALLY_LEFT_X, TALLY_LEFT_Y, 0, 
