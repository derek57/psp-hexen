...
//#define DEFAULT_RAM 16 /* MiB */		// CHANGED FOR PSP: THIS CAUSES RANDOMLY VOICES NOT...
#define DEFAULT_RAM 8  /* MiB */		// ...PLAYING, SO EVEN THE ACTUAL DOS VERSION OF THE... 
#define MIN_RAM     4  /* MiB */		// ...GAME ONLY REQUIRES 8 MB OF RAM
...
//    if(devparm)
//    	printf("zone memory: %d, %d allocated for zone\n", 
//           	*zonemem, *size);
...
void I_PrintStartupBanner(char *gamedescription)
{
    ...
    printf(
    " " "Chocolate Doom 2.0.0" " is free software, covered by the GNU General Public\n"
...
*/
    ...
    sceKernelDelayThread(10*1000);	// ADDED FOR PSP SHUTDOWN
    sceKernelExitGame();		// ADDED FOR PSP SHUTDOWN
}
...
void I_Error (char *error, ...)
{
	...
	sceRtcGetCurrentClockLocalTime(&error_time);

	sprintf(date, "%d/%d/%d %2.2d:%2.2d",
		error_time.year,
		error_time.month,
		error_time.day,
		error_time.hour,
...
boolean I_GetMemoryValue(unsigned int offset, void *value, int size)
{
    ...
    if (firsttime)
    {
//        int i, p, val;			// PSP-GCC v4.8.2 compiler warning

        firsttime = false;
//        i = 0;				// PSP-GCC v4.8.2 compiler warning
