...
*/
    ...
    if (gamekeydown[key_use] && mousey && !paused)
    {
	// We'll directly change the viewing pitch of the console player.
	float adj = ((mousey*0x4) << 16) / (float) 0x80000000*180*110.0/85.0;
...
*/
    if(extra_wad_loaded == 1 && !datadisc)
    {
//	sprintf(savedescription, "MAP%2.2d %d/%d/%d %2.2d:%2.2d *",
	sprintf(savedescription, "MAP%2.2d *",
		gamemap
/*
		,
		savegame_time.year,
...
*/
    ...
    else if(extra_wad_loaded == 1 && datadisc)
    {
//	sprintf(savedescription, "MAP%2.2d %d/%d/%d %2.2d:%2.2d *",
	sprintf(savedescription, "MAP%2.2d *",
		gamemapx
